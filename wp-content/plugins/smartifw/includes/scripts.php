...
function smart_ifw_site_scripts() {
	...
	wp_enqueue_style('smart-ifw-site', SMART_IFW_URL . 'assets/css/smart_ifw_site.css', true, '1.0.4');
...
function smart_ifw_admin_scripts() {
	...
	wp_enqueue_script('smartifw-shortcode-backend', SMART_IFW_URL . 'assets/js/shortcode-backend.js', array( 'jquery', 'wp-color-picker' ),true, '1.0.4');
	wp_enqueue_style('smart-ifw-admin', SMART_IFW_URL . 'assets/css/smart_ifw_admin.css', true, '1.0.4');
	if($smart_ifw['switch_cdn'] == 'on'){
	wp_enqueue_style('smart-ifw-fa', '//netdna.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css', false, '4.3.0');
	} else {
	wp_enqueue_style('smart-ifw-fa', SMART_IFW_URL . 'assets/css/font-awesome.min.css', false, '4.3.0');
	}
	wp_enqueue_style('jquery-chosen',  SMART_IFW_URL . 'assets/css/chosen.min.css', true, '1.0.4');
	}
